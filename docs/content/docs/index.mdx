...
import { Sparkles, MessagesSquare, FolderGit2, Palette } from 'lucide-react';
...
- Interactive theme builder to visually design and export themes with [Forui Create](https://create.forui.dev).
...
- Actively maintained since [mid 2024](https://github.com/duobaseio/forui/releases/tag/forui/0.1.0).
...
<Cards>
  ...
  <Card icon={<Palette />} title="Forui Create" href="https://create.forui.dev" />
