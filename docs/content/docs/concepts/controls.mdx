...
import liftedSnippet from '@/snippets/snippets/core_concepts/controls/lifted.json';
import managedSnippet from '@/snippets/snippets/core_concepts/controls/managed.json';
import customManagedSnippet from '@/snippets/snippets/core_concepts/controls/custom_managed.json';
import extendManagedSnippet from '@/snippets/snippets/core_concepts/controls/extend_managed.json';
