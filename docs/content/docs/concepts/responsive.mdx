...
import usageSnippet from '@/snippets/snippets/core_concepts/responsive/usage.json';
import customBreakpointsSnippet from '@/snippets/snippets/core_concepts/responsive/custom_breakpoints.json';
import customBreakpointsUsageSnippet from '@/snippets/snippets/core_concepts/responsive/custom_breakpoints_usage.json';
