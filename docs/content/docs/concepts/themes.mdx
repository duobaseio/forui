...
Forui includes a single predefined theme, `FTheme.neutral`. To generate a custom theme, use [create.forui.dev](https://create.forui.dev)
or the [CLI](/docs/reference/cli#theme). The generated theme lives in your project, so you can modify it directly to fit
your design needs.
