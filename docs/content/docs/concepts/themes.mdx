...
import approximateMaterialThemeSnippet from '@/snippets/snippets/concepts/themes/material_interop/apporximate_material_theme.json';
...
To learn how to customize styles and `FVariants`, see the [customizing widget styles](/docs/guides/customizing-widget-styles)
guide.
