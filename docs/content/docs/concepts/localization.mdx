...
import defaultSnippet from '@/snippets/snippets/core_concepts/localization/default.json';
import localizationSnippet from '@/snippets/snippets/core_concepts/localization/localization.json';
