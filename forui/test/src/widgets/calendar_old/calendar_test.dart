...
void main() {
      ...
      await tester.pumpWidget(
        TestScaffold.app(
          child: StatefulBuilder(
            builder: (context, setState) => FCalendarOld(
  ...
  testWidgets('initial type changes', (tester) async {
    final type = autoDispose(ValueNotifier(FCalendarOldPickerType.yearMonth));

    await tester.pumpWidget(
      TestScaffold.app(
        child: ValueListenableBuilder(
          valueListenable: type,
          builder: (context, value, _) => FCalendarOld(
  ...
  testWidgets('initial month changes', (tester) async {
    final controller = autoDispose(FCalendarOldController.date(initial: DateTime(2024, 7, 14)));
