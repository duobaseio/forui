  ...
  testWidgets('style changes when passed in style changes', (tester) async {
    await tester.pumpWidget(
      TestScaffold(
        child: FSidebarItem(
          key: const Key('item'),
          style: FThemeData(touch: true, colors: FColors.neutral.light).sidebarStyle.groupStyle.itemStyle,
          label: const Text('Item'),
          onPress: () {},
        ),
      ),
    ...
    await tester.pumpWidget(
      TestScaffold(
        child: FSidebarItem(
          key: const Key('item'),
          style: FThemeData(touch: true, colors: FColors.neutral.dark).sidebarStyle.groupStyle.itemStyle,
          label: const Text('Item'),
          onPress: () {},
        ),
      ),
