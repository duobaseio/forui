...
void main() {
  testWidgets('FTheme', (tester) async {
    ...
    await tester.pumpWidget(sheet.record(Application(data: FThemeData(touch: true, colors: FColors.neutral.light), key: const ValueKey('key'))));
    await tester.pumpFrames(
      sheet.record(Application(data: FThemeData(touch: false, colors: FColors.neutral.dark), key: const ValueKey('key'))),
