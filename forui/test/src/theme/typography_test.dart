  ...
  group('FTypography', () {
    ...
    setUp(() {
      typography = const FTypography(
        ...
        xs2: TextStyle(fontSize: 1),
        xs: TextStyle(fontSize: 2),
        sm: TextStyle(fontSize: 3),
        md: TextStyle(fontSize: 4),
        lg: TextStyle(fontSize: 5),
        xl: TextStyle(fontSize: 6),
        xl2: TextStyle(fontSize: 7),
        xl3: TextStyle(fontSize: 8),
        xl4: TextStyle(fontSize: 9),
        xl5: TextStyle(fontSize: 10),
        xl6: TextStyle(fontSize: 11),
        xl7: TextStyle(fontSize: 12),
        xl8: TextStyle(fontSize: 13),
      );
    });
    ...
    group('scale(...)', () {
      test('no arguments', () {
        ...
        expect(typography.xs2, const TextStyle(fontSize: 1));
        expect(typography.xs, const TextStyle(fontSize: 2));
        expect(typography.sm, const TextStyle(fontSize: 3));
        expect(typography.md, const TextStyle(fontSize: 4));
        expect(typography.lg, const TextStyle(fontSize: 5));
        expect(typography.xl, const TextStyle(fontSize: 6));
        expect(typography.xl2, const TextStyle(fontSize: 7));
        expect(typography.xl3, const TextStyle(fontSize: 8));
        expect(typography.xl4, const TextStyle(fontSize: 9));
        expect(typography.xl5, const TextStyle(fontSize: 10));
        expect(typography.xl6, const TextStyle(fontSize: 11));
        expect(typography.xl7, const TextStyle(fontSize: 12));
        expect(typography.xl8, const TextStyle(fontSize: 13));
      });
      ...
      test('all arguments', () {
        ...
        expect(typography.defaultFontFamily, 'Roboto');
        expect(typography.xs2, const TextStyle(fontSize: 10));
        expect(typography.xs, const TextStyle(fontSize: 20));
        expect(typography.sm, const TextStyle(fontSize: 30));
        expect(typography.md, const TextStyle(fontSize: 40));
        expect(typography.lg, const TextStyle(fontSize: 50));
        expect(typography.xl, const TextStyle(fontSize: 60));
        expect(typography.xl2, const TextStyle(fontSize: 70));
        expect(typography.xl3, const TextStyle(fontSize: 80));
        expect(typography.xl4, const TextStyle(fontSize: 90));
        expect(typography.xl5, const TextStyle(fontSize: 100));
        expect(typography.xl6, const TextStyle(fontSize: 110));
        expect(typography.xl7, const TextStyle(fontSize: 120));
        expect(typography.xl8, const TextStyle(fontSize: 130));
      });
    });
    ...
    group('copyWith(...)', () {
      ...
      test('all arguments', () {
        final typography = const FTypography().copyWith(
          xs2: const TextStyle(fontSize: 1),
          xs: const TextStyle(fontSize: 2),
          sm: const TextStyle(fontSize: 3),
          md: const TextStyle(fontSize: 4),
          lg: const TextStyle(fontSize: 5),
          xl: const TextStyle(fontSize: 6),
          xl2: const TextStyle(fontSize: 7),
          xl3: const TextStyle(fontSize: 8),
          xl4: const TextStyle(fontSize: 9),
          xl5: const TextStyle(fontSize: 10),
          xl6: const TextStyle(fontSize: 11),
          xl7: const TextStyle(fontSize: 12),
          xl8: const TextStyle(fontSize: 13),
        );
    ...
    test('debugFillProperties', () {
      ...
      expect(
        ...
        [
          ...
          DiagnosticsProperty('xs2', const TextStyle(fontSize: 1)),
          DiagnosticsProperty('xs', const TextStyle(fontSize: 2)),
          DiagnosticsProperty('sm', const TextStyle(fontSize: 3)),
          DiagnosticsProperty('md', const TextStyle(fontSize: 4)),
          DiagnosticsProperty('lg', const TextStyle(fontSize: 5)),
          DiagnosticsProperty('xl', const TextStyle(fontSize: 6)),
          DiagnosticsProperty('xl2', const TextStyle(fontSize: 7)),
          DiagnosticsProperty('xl3', const TextStyle(fontSize: 8)),
          DiagnosticsProperty('xl4', const TextStyle(fontSize: 9)),
          DiagnosticsProperty('xl5', const TextStyle(fontSize: 10)),
          DiagnosticsProperty('xl6', const TextStyle(fontSize: 11)),
          DiagnosticsProperty('xl7', const TextStyle(fontSize: 12)),
          DiagnosticsProperty('xl8', const TextStyle(fontSize: 13)),
        ].map((p) => p.toString()),
      );
    });
    ...
    group('equality and hashcode', () {
      ...
      test('not equal', () {
        final copy = typography.copyWith(xs2: const TextStyle(fontSize: 100));
