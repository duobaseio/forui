...
enum Style {
  ...
  fbuttonstyles(
    'FButtonStyles',
    'FVariants<FButtonVariantConstraint, FButtonVariant, FButtonSizes, FButtonSizesDelta>',
    <String>['buttons'],
  ...
  ftilerawcontentstyle(
    'FTileRawContentStyle',
    null,
    <String>['tile-raw-content', 'tilerawcontent'],
    <String>['FTileRawContentStyle'],
    'FTileRawContentStyle tileRawContentStyle({\n  required FColors colors,\n  required FTypography typography,\n  required Color prefix,\n  required Color color,\n}) => FTileRawContentStyle(\n  prefixIconStyle: FVariants.from(\n    IconThemeData(color: prefix, size: 18),\n    variants: {\n      [.disabled]: .delta(color: colors.disable(prefix)),\n    },\n  ),\n  childTextStyle: FVariants(\n    typography.base.copyWith(color: color),\n    variants: {\n      [.disabled]: typography.base.copyWith(color: colors.disable(color)),\n    },\n  ),\n  padding: const EdgeInsets.fromLTRB(15, 13, 10, 13),\n  prefixIconSpacing: 10,\n);\n',
  ),
  ftilestyle(
    'FTileStyle',
    null,
    <String>['tile'],
    <String>['FTileStyle', 'FTileContentStyle', 'FTileRawContentStyle'],
    'FTileStyle tileStyle({\n  required FColors colors,\n  required FTypography typography,\n  required FStyle style,\n}) => FTileStyle(\n  backgroundColor: .all(colors.card),\n  decoration: FVariants.from(\n    BoxDecoration(\n      color: colors.card,\n      border: .all(color: colors.border),\n      borderRadius: style.borderRadius,\n    ),\n    variants: {\n      [.hovered, .pressed]: .delta(color: colors.secondary),\n      [.disabled]: .delta(color: colors.disable(colors.secondary)),\n    },\n  ),\n  contentStyle: _tileContentStyle(\n    colors: colors,\n    typography: typography,\n    prefix: colors.primary,\n    foreground: colors.foreground,\n    mutedForeground: colors.mutedForeground,\n  ),\n  rawItemContentStyle: _tileRawContentStyle(\n    colors: colors,\n    typography: typography,\n    prefix: colors.primary,\n    color: colors.foreground,\n  ),\n  tappableStyle: style.tappableStyle.copyWith(\n    motion: FTappableMotion.none,\n    pressedEnterDuration: .zero,\n    pressedExitDuration: const Duration(milliseconds: 25),\n  ),\n  focusedOutlineStyle: style.focusedOutlineStyle,\n  margin: .zero,\n);\n',
  ),
  ftilestyles(
    'FTileStyles',
    'FVariants<FItemVariantConstraint, FItemVariant, FTileStyle, FTileStyleDelta>',
    <String>['tiles'],
    <String>['FTileStyles', 'FTileContentStyle', 'FTileRawContentStyle'],
    'FVariants<FItemVariantConstraint, FItemVariant, FTileStyle, FTileStyleDelta>\ntileStyles({\n  required FColors colors,\n  required FTypography typography,\n  required FStyle style,\n}) => FVariants.from(\n  .inherit(colors: colors, typography: typography, style: style),\n  variants: {\n    [.destructive]: .delta(\n      contentStyle: _tileContentStyle(\n        colors: colors,\n        typography: typography,\n        prefix: colors.destructive,\n        foreground: colors.destructive,\n        mutedForeground: colors.destructive,\n      ),\n      rawItemContentStyle: _tileRawContentStyle(\n        colors: colors,\n        typography: typography,\n        prefix: colors.destructive,\n        color: colors.destructive,\n      ),\n    ),\n  },\n);\n',
  ),
  ftimefieldstyle(
    'FTimeFieldStyle',
