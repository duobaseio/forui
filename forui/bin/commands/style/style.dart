...
enum Style {
  ...
  fautocompletesizestyles(
    'FAutocompleteSizeStyles',
    'FVariants<FTextFieldSizeVariantConstraint, FTextFieldSizeVariant, FAutocompleteStyle, FAutocompleteStyleDelta>',
    <String>['autocomplete-sizes', 'autocompletesizes'],
    <String>[
      'FAutocompleteSizeStyles',
    ...
    'FAutocompleteSizeStyles autocompleteSizeStyles({\n  required FColors colors,\n  required FTypography typography,\n  required FStyle style,\n  bool desktop = false,\n}) {\n  final fieldStyles = _textFieldSizeStyles(\n    colors: colors,\n    typography: typography,\n    style: style,\n    desktop: desktop,\n  );\n  final contentStyle = _autocompleteContentStyle(\n    colors: colors,\n    typography: typography,\n    style: style,\n    desktop: desktop,\n  );\n  final md = _autocompleteStyle(\n    fieldStyle: fieldStyles.md,\n    colors: colors,\n    contentStyle: contentStyle,\n  );\n  return FAutocompleteSizeStyles(\n    FVariants(\n      md,\n      variants: {\n        [.sm]: _autocompleteStyle(\n          fieldStyle: fieldStyles.sm,\n          colors: colors,\n          contentStyle: contentStyle,\n        ),\n        [.md]: md,\n        [.lg]: _autocompleteStyle(\n          fieldStyle: fieldStyles.lg,\n          colors: colors,\n          contentStyle: contentStyle,\n        ),\n      },\n    ),\n  );\n}\n',
  ),
  fautocompletestyle(
    'FAutocompleteStyle',
    null,
    <String>['autocomplete'],
    <String>['FAutocompleteStyle'],
    'FAutocompleteStyle autocompleteStyle({\n  required FTextFieldStyle fieldStyle,\n  required FColors colors,\n  required FAutocompleteContentStyle contentStyle,\n}) => FAutocompleteStyle(\n  composingTextStyle: const TextStyle(decoration: TextDecoration.underline),\n  typeaheadTextStyle: TextStyle(color: colors.mutedForeground),\n  contentStyle: contentStyle,\n  keyboardAppearance: fieldStyle.keyboardAppearance,\n  color: fieldStyle.color,\n  cursorColor: fieldStyle.cursorColor,\n  contentPadding: fieldStyle.contentPadding,\n  clearButtonPadding: fieldStyle.clearButtonPadding,\n  obscureButtonPadding: fieldStyle.obscureButtonPadding,\n  scrollPadding: fieldStyle.scrollPadding,\n  iconStyle: fieldStyle.iconStyle,\n  clearButtonStyle: fieldStyle.clearButtonStyle,\n  obscureButtonStyle: fieldStyle.obscureButtonStyle,\n  contentTextStyle: fieldStyle.contentTextStyle,\n  hintTextStyle: fieldStyle.hintTextStyle,\n  counterTextStyle: fieldStyle.counterTextStyle,\n  border: fieldStyle.border,\n  labelTextStyle: fieldStyle.labelTextStyle,\n  descriptionTextStyle: fieldStyle.descriptionTextStyle,\n  errorTextStyle: fieldStyle.errorTextStyle,\n  labelPadding: fieldStyle.labelPadding,\n  descriptionPadding: fieldStyle.descriptionPadding,\n  errorPadding: fieldStyle.errorPadding,\n  childPadding: fieldStyle.childPadding,\n  labelMotion: fieldStyle.labelMotion,\n);\n',
  ),
  favatarstyle(
    'FAvatarStyle',
    null,
  ...
  fbuttonsizestyles(
    ...
    <String>['FButtonSizeStyles', 'FButtonStyle'],
  ...
  fbuttonstyles(
    ...
    <String>['buttons'],
    <String>['FButtonStyles', 'FButtonSizeStyles', 'FButtonStyle'],
  ...
  fcardstyle(
    ...
    <String>['card'],
    <String>['FCardStyle'],
    'FCardStyle cardStyle({\n  required FColors colors,\n  required FTypography typography,\n  required FStyle style,\n  bool desktop = false,\n}) => FCardStyle(\n  decoration: ShapeDecoration(\n    shape: RoundedSuperellipseBorder(\n      side: BorderSide(color: colors.border, width: style.borderWidth),\n      borderRadius: style.borderRadius.lg,\n    ),\n    color: colors.card,\n  ),\n  contentStyle: FCardContentStyle(\n    titleTextStyle: (desktop ? typography.md : typography.lg).copyWith(\n      fontWeight: .w500,\n      color: colors.foreground,\n    ),\n    subtitleTextStyle: typography.sm.copyWith(color: colors.mutedForeground),\n  ),\n);\n',
  ),
  fcheckboxstyle(
    'FCheckboxStyle',
    null,
  ...
  fcircularprogresssizestyles(
    'FCircularProgressSizeStyles',
    'FVariants<FCircularProgressSizeVariantConstraint, FCircularProgressSizeVariant, FCircularProgressStyle, FCircularProgressStyleDelta>',
    <String>['circular-progress-sizes', 'circularprogresssizes'],
    <String>['FCircularProgressSizeStyles', 'FCircularProgressStyle'],
    'FCircularProgressSizeStyles circularProgressSizeStyles({\n  required FColors colors,\n  required FTypography typography,\n}) {\n  final md = _circularProgressStyle(\n    colors: colors,\n    iconSize: typography.md.fontSize!,\n  );\n  return FCircularProgressSizeStyles(\n    FVariants(\n      md,\n      variants: {\n        [.xs]: _circularProgressStyle(\n          colors: colors,\n          iconSize: typography.xs.fontSize!,\n        ),\n        [.sm]: _circularProgressStyle(\n          colors: colors,\n          iconSize: typography.sm.fontSize!,\n        ),\n        [.md]: md,\n        [.lg]: _circularProgressStyle(\n          colors: colors,\n          iconSize: typography.lg.fontSize!,\n        ),\n        [.xl]: _circularProgressStyle(\n          colors: colors,\n          iconSize: typography.xl.fontSize!,\n        ),\n      },\n    ),\n  );\n}\n',
  ),
  fcircularprogressstyle(
    'FCircularProgressStyle',
    null,
  ...
  fmultiselectfieldstyle(
    ...
    <String>['FMultiSelectFieldStyle', 'FLabelStyles', 'FButtonStyles', 'FButtonSizeStyles', 'FButtonStyle'],
