...
sealed class FFocusedOutlineStyleDelta with Delta<FFocusedOutlineStyle> {
  /// Creates a complete replacement for a [FFocusedOutlineStyle].
  const factory FFocusedOutlineStyleDelta.replace(FFocusedOutlineStyle replacement) = _FFocusedOutlineStyleReplace;

  /// Creates a partial modification of a [FFocusedOutlineStyle].
  const factory FFocusedOutlineStyleDelta.merge({
    Color? color,
    BorderRadiusGeometry? borderRadius,
    double? width,
    double? spacing,
  }) = _FFocusedOutlineStyleMerge;
}

class _FFocusedOutlineStyleReplace implements FFocusedOutlineStyleDelta {
  const _FFocusedOutlineStyleReplace(this._replacement);

  final FFocusedOutlineStyle _replacement;

  @override
  FFocusedOutlineStyle call(FFocusedOutlineStyle _) => _replacement;
}

class _FFocusedOutlineStyleMerge implements FFocusedOutlineStyleDelta {
  const _FFocusedOutlineStyleMerge({this.color, this.borderRadius, this.width, this.spacing});
