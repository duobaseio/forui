...
extension type const FTappableVariantConstraint._(FVariantConstraint _) implements FVariantConstraint {
  ...
  factory not(FTappableVariant variant) => FTappableVariantConstraint._(Not(variant));
...
abstract class FTappableStyleDelta with Delta {
  ...
  const factory context() = _FTappableStyleContext;
...
class _FTappableStyleDelta implements FTappableStyleDelta {
  const new({this.cursor, this.pressedEnterDuration, this.pressedExitDuration, this.motion});
...
abstract class FTappableMotionDelta with Delta {
  ...
  const factory context() = _FTappableMotionContext;
