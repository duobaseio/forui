...
mixin _$FThemeDataFunctions on Diagnosticable {
  ...
  FIcons get icons;
  FStyle get style;
  FHapticFeedback get hapticFeedback;
  ...
  FCircularProgressSizeStyles get circularProgressStyles;
  FDateFieldStyle get dateFieldStyle;
  FDateTimePickerStyle get dateTimePickerStyle;
  ...
  FOtpFieldStyle get otpFieldStyle;
  ...
  FTextFieldSizeStyles get textFieldStyles;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('icons', icons, level: .debug))
      ...
      ..add(DiagnosticsProperty('circularProgressStyles', circularProgressStyles, level: .debug))
      ..add(DiagnosticsProperty('dateFieldStyle', dateFieldStyle, level: .debug))
      ..add(DiagnosticsProperty('dateTimePickerStyle', dateTimePickerStyle, level: .debug))
      ...
      ..add(DiagnosticsProperty('otpFieldStyle', otpFieldStyle, level: .debug))
      ...
      ..add(DiagnosticsProperty('textFieldStyles', textFieldStyles, level: .debug))
  ...
  bool operator ==(Object other) =>
      ...
      (other is FThemeData &&
          ...
          circularProgressStyles == other.circularProgressStyles &&
          dateFieldStyle == other.dateFieldStyle &&
          dateTimePickerStyle == other.dateTimePickerStyle &&
          ...
          otpFieldStyle == other.otpFieldStyle &&
          ...
          textFieldStyles == other.textFieldStyles &&
  ...
  int get hashCode =>
      ...
      circularProgressStyles.hashCode ^
      dateFieldStyle.hashCode ^
      dateTimePickerStyle.hashCode ^
