...
class FLocalizationsAs extends FLocalizations {
  ...
  String autocompleteSuggestion(String suggestion) {
    return 'পৰামৰ্শ: $suggestion';
  }

  @override
  String bottomNavigationBarTabSemanticsLabel(int tabIndex, int tabCount) {
    return '$tabCountৰ $tabIndex নম্বৰ টেব';
  }

  @override
  String get breadcrumbCollapsedSemanticsLabel => 'অধিক';
  ...
  @override
  String get headerBackSemanticsLabel => 'উভতি যাওক';

  @override
  String get headerCloseSemanticsLabel => 'বন্ধ কৰক';
