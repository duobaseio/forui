...
extension $FLabelStylesTransformations on FLabelStyles {
  ...
  ///
  /// ## Parameters
  /// * [FLabelStyles.horizontalLeadingStyle] - The [FLabelLayout.horizontalLeading] style.
  /// * [FLabelStyles.horizontalTrailingStyle] - The [FLabelLayout.horizontalTrailing] style.
  /// * [FLabelStyles.verticalStyle] - The [FLabelLayout.vertical] style.
  @useResult
...
mixin _$FLabelStylesFunctions on Diagnosticable implements FLabelStylesDelta {
  ...
  FLabelStyle get horizontalLeadingStyle;
  FLabelStyle get horizontalTrailingStyle;
  FLabelStyle get verticalStyle;
  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('horizontalLeadingStyle', horizontalLeadingStyle, level: .debug))
      ..add(DiagnosticsProperty('horizontalTrailingStyle', horizontalTrailingStyle, level: .debug))
  ...
  bool operator ==(Object other) =>
      ...
      (other is FLabelStyles &&
          ...
          horizontalLeadingStyle == other.horizontalLeadingStyle &&
          horizontalTrailingStyle == other.horizontalTrailingStyle &&
          verticalStyle == other.verticalStyle);

  @override
  int get hashCode => horizontalLeadingStyle.hashCode ^ horizontalTrailingStyle.hashCode ^ verticalStyle.hashCode;
}
...
abstract class FLabelStylesDelta with Delta {
  ...
  const factory context() = _FLabelStylesContext;
...
class _FLabelStylesDelta implements FLabelStylesDelta {
  const new({this.horizontalLeadingStyle, this.horizontalTrailingStyle, this.verticalStyle});

  final FLabelStyleDelta? horizontalLeadingStyle;

  final FLabelStyleDelta? horizontalTrailingStyle;

  final FLabelStyleDelta? verticalStyle;

  @override
  FLabelStyles call(FLabelStyles original) => FLabelStyles(
    horizontalLeadingStyle:
        horizontalLeadingStyle?.call(original.horizontalLeadingStyle) ?? original.horizontalLeadingStyle,
    horizontalTrailingStyle:
        horizontalTrailingStyle?.call(original.horizontalTrailingStyle) ?? original.horizontalTrailingStyle,
...
abstract class FLabelStyleDelta with Delta {
  ...
  const factory context() = _FLabelStyleContext;
...
abstract class FLabelMotionDelta with Delta {
  ...
  const factory context() = _FLabelMotionContext;
