...
sealed class FSelectGroupStyleDelta with Delta<FSelectGroupStyle> {
  /// Creates a complete replacement for a [FSelectGroupStyle].
  const factory FSelectGroupStyleDelta.replace(FSelectGroupStyle replacement) = _FSelectGroupStyleReplace;

  /// Creates a partial modification of a [FSelectGroupStyle].
  const factory FSelectGroupStyleDelta.merge({
  ...
  }) = _FSelectGroupStyleMerge;
}

class _FSelectGroupStyleReplace implements FSelectGroupStyleDelta {
  const _FSelectGroupStyleReplace(this._replacement);

  final FSelectGroupStyle _replacement;

  @override
  FSelectGroupStyle call(FSelectGroupStyle _) => _replacement;
}

class _FSelectGroupStyleMerge implements FSelectGroupStyleDelta {
  const _FSelectGroupStyleMerge({
    this.checkboxStyle,
    this.radioStyle,
    this.itemPadding,
    this.labelPadding,
