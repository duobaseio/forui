...
extension $FDateFieldStyleTransformations on FDateFieldStyle {
  ...
  ///
  /// ## Parameters
  /// * [FDateFieldStyle.fieldStyles] - The date field's text-field styles.
...
abstract class FDateFieldStyleDelta with Delta {
  ...
  const factory context() = _FDateFieldStyleContext;
...
class _FDateFieldStyleDelta implements FDateFieldStyleDelta {
  const new({this.fieldStyles, this.popoverStyle, this.calendarStyle});
