...
extension $FTileGroupStyleTransformations on FTileGroupStyle {
  ...
  /// * [FTileGroupStyle.slidePressHapticFeedback] - The haptic feedback for when the user slides from one tile to another when [slideableTiles] is enabled.
  ...
  FTileGroupStyle copyWith({
    ...
    tileStyles: FTileStyles(tileStyles?.call(this.tileStyles) ?? this.tileStyles),
  ...
  FTileGroupStyle lerp(FTileGroupStyle other, double t) => .new(
    ...
    tileStyles: FTileStyles(.lerpWhere(tileStyles, other.tileStyles, t, (a, b, t) => a!.lerp(b!, t))),
...
abstract class FTileGroupStyleDelta with Delta {
  ...
  const factory context() = _FTileGroupStyleContext;
...
class _FTileGroupStyleDelta implements FTileGroupStyleDelta {
  ...
  FTileGroupStyle call(FTileGroupStyle original) => FTileGroupStyle(
    ...
    tileStyles: FTileStyles(tileStyles?.call(original.tileStyles) ?? original.tileStyles),
