...
extension $FTileStyleTransformations on FTileStyle {
  ...
  ///
  /// ## Parameters
  /// * [FTileStyle.shape] - The item's outer shape when outside of an [FItemGroup] or other similar groups.
  ...
  /// * [FTileStyle.decoration] - The item's inner decoration that is drawn above the [backgroundColor] but below the content.
