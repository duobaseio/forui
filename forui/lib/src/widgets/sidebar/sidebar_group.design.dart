...
sealed class FSidebarGroupStyleDelta with Delta<FSidebarGroupStyle> {
  /// Creates a complete replacement for a [FSidebarGroupStyle].
  const factory FSidebarGroupStyleDelta.replace(FSidebarGroupStyle replacement) = _FSidebarGroupStyleReplace;

  /// Creates a partial modification of a [FSidebarGroupStyle].
  const factory FSidebarGroupStyleDelta.merge({
    EdgeInsets? padding,
    double? headerSpacing,
    EdgeInsetsGeometry? headerPadding,
  ...
  }) = _FSidebarGroupStyleMerge;
}

class _FSidebarGroupStyleReplace implements FSidebarGroupStyleDelta {
  const _FSidebarGroupStyleReplace(this._replacement);

  final FSidebarGroupStyle _replacement;

  @override
  FSidebarGroupStyle call(FSidebarGroupStyle _) => _replacement;
}

class _FSidebarGroupStyleMerge implements FSidebarGroupStyleDelta {
  const _FSidebarGroupStyleMerge({
    this.padding,
    this.headerSpacing,
    this.headerPadding,
    this.labelStyle,
  ...
  FSidebarGroupStyle call(FSidebarGroupStyle original) => FSidebarGroupStyle(
    ...
    actionStyle: actionStyle ?? original.actionStyle,
