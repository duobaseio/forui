...
sealed class FAutocompleteSectionStyleDelta with Delta<FAutocompleteSectionStyle> {
  /// Creates a complete replacement for a [FAutocompleteSectionStyle].
  const factory FAutocompleteSectionStyleDelta.replace(FAutocompleteSectionStyle replacement) =
      _FAutocompleteSectionStyleReplace;

  /// Creates a partial modification of a [FAutocompleteSectionStyle].
  const factory FAutocompleteSectionStyleDelta.merge({
    FWidgetStateMap<TextStyle>? labelTextStyle,
    EdgeInsetsGeometry? labelPadding,
    FWidgetStateMap<Color>? dividerColor,
    double? dividerWidth,
    FItemStyleDelta? itemStyle,
  }) = _FAutocompleteSectionStyleMerge;
}

class _FAutocompleteSectionStyleReplace implements FAutocompleteSectionStyleDelta {
  const _FAutocompleteSectionStyleReplace(this._replacement);

  final FAutocompleteSectionStyle _replacement;

  @override
  FAutocompleteSectionStyle call(FAutocompleteSectionStyle _) => _replacement;
}

class _FAutocompleteSectionStyleMerge implements FAutocompleteSectionStyleDelta {
  const _FAutocompleteSectionStyleMerge({
    this.labelTextStyle,
    this.labelPadding,
    this.dividerColor,
    this.dividerWidth,
