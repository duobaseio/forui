...
sealed class FAutocompleteStyleDelta with Delta<FAutocompleteStyle> {
  /// Creates a complete replacement for a [FAutocompleteStyle].
  const factory FAutocompleteStyleDelta.replace(FAutocompleteStyle replacement) = _FAutocompleteStyleReplace;

  /// Creates a partial modification of a [FAutocompleteStyle].
  const factory FAutocompleteStyleDelta.merge({
...
class _FAutocompleteStyleReplace implements FAutocompleteStyleDelta {
  const _FAutocompleteStyleReplace(this._replacement);

  final FAutocompleteStyle _replacement;

  @override
  FAutocompleteStyle call(FAutocompleteStyle _) => _replacement;
}

class _FAutocompleteStyleMerge implements FAutocompleteStyleDelta {
  const _FAutocompleteStyleMerge({
    this.fieldStyle,
  ...
  FAutocompleteStyle call(FAutocompleteStyle original) => FAutocompleteStyle(
    ...
    composingTextStyle: composingTextStyle ?? original.composingTextStyle,
    typeaheadTextStyle: typeaheadTextStyle ?? original.typeaheadTextStyle,
