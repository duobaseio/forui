...
sealed class FCalendarStyleDelta with Delta<FCalendarStyle> {
  /// Creates a complete replacement for a [FCalendarStyle].
  const factory FCalendarStyleDelta.replace(FCalendarStyle replacement) = _FCalendarStyleReplace;

  /// Creates a partial modification of a [FCalendarStyle].
  const factory FCalendarStyleDelta.merge({
    ...
    EdgeInsetsGeometry? padding,
    Duration? pageAnimationDuration,
  }) = _FCalendarStyleMerge;
}

class _FCalendarStyleReplace implements FCalendarStyleDelta {
  const _FCalendarStyleReplace(this._replacement);

  final FCalendarStyle _replacement;

  @override
  FCalendarStyle call(FCalendarStyle _) => _replacement;
}

class _FCalendarStyleMerge implements FCalendarStyleDelta {
  const _FCalendarStyleMerge({
    this.headerStyle,
    this.dayPickerStyle,
    this.yearMonthPickerStyle,
    this.decoration,
