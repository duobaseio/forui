...
mixin _$_LiftedMixin<T> on Diagnosticable, FDateSelectionControl<T> {
  bool Function(DateTime) get selected;
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is _Lifted && runtimeType == other.runtimeType && selected == other.selected && select == other.select);

  @override
  int get hashCode => selected.hashCode ^ select.hashCode;
}
