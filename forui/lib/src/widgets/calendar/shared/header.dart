          ...
          children: [
            ...
            RotationTransition(
              ...
              child: Padding(
                ...
                child: IconTheme(
                  data: widget.style.buttonStyle.iconContentStyle.iconStyle.resolve(variants).copyWith(
                    color: widget.style.headerTextStyle.color,
                    size: widget.style.headerIconSize,
                  ),
