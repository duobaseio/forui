...
extension type const FSwitchVariantConstraint._(FVariantConstraint _) implements FVariantConstraint {
  ...
  factory not(FSwitchVariant variant) => FSwitchVariantConstraint._(Not(variant));
...
abstract class FSwitchStyleDelta with Delta {
  ...
  const factory context() = _FSwitchStyleContext;
...
class _FSwitchStyleDelta implements FSwitchStyleDelta {
  const new({this.focusColor, this.trackColor, this.thumbColor, this.leadingLabelStyle, this.trailingLabelStyle});
