...
extension type const FAlertVariantConstraint._(FVariantConstraint _) implements FVariantConstraint {
  ...
  factory not(FAlertVariant variant) => FAlertVariantConstraint._(Not(variant));
...
abstract class FAlertStyleDelta with Delta {
  ...
  const factory context() = _FAlertStyleContext;
...
class _FAlertStyleDelta implements FAlertStyleDelta {
  const new({this.decoration, this.iconStyle, this.titleTextStyle, this.subtitleTextStyle, this.padding});
