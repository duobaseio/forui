...
sealed class FCardContentStyleDelta with Delta<FCardContentStyle> {
  /// Creates a complete replacement for a [FCardContentStyle].
  const factory FCardContentStyleDelta.replace(FCardContentStyle replacement) = _FCardContentStyleReplace;

  /// Creates a partial modification of a [FCardContentStyle].
  const factory FCardContentStyleDelta.merge({
    double? imageSpacing,
    double? subtitleSpacing,
    TextStyleDelta? titleTextStyle,
    TextStyleDelta? subtitleTextStyle,
    EdgeInsetsGeometry? padding,
  }) = _FCardContentStyleMerge;
}

class _FCardContentStyleReplace implements FCardContentStyleDelta {
  const _FCardContentStyleReplace(this._replacement);

  final FCardContentStyle _replacement;

  @override
  FCardContentStyle call(FCardContentStyle _) => _replacement;
}

class _FCardContentStyleMerge implements FCardContentStyleDelta {
  const _FCardContentStyleMerge({
    this.imageSpacing,
