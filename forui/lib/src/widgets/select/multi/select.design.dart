...
sealed class FMultiSelectStyleDelta with Delta<FMultiSelectStyle> {
  /// Creates a complete replacement for a [FMultiSelectStyle].
  const factory FMultiSelectStyleDelta.replace(FMultiSelectStyle replacement) = _FMultiSelectStyleReplace;

  /// Creates a partial modification of a [FMultiSelectStyle].
  const factory FMultiSelectStyleDelta.merge({
  ...
  }) = _FMultiSelectStyleMerge;
}

class _FMultiSelectStyleReplace implements FMultiSelectStyleDelta {
  const _FMultiSelectStyleReplace(this._replacement);

  final FMultiSelectStyle _replacement;

  @override
  FMultiSelectStyle call(FMultiSelectStyle _) => _replacement;
}

class _FMultiSelectStyleMerge implements FMultiSelectStyleDelta {
  const _FMultiSelectStyleMerge({
    this.fieldStyle,
    this.tagStyle,
    this.searchStyle,
    this.contentStyle,
...
sealed class FMultiSelectFieldStyleDelta with Delta<FMultiSelectFieldStyle> {
  /// Creates a complete replacement for a [FMultiSelectFieldStyle].
  const factory FMultiSelectFieldStyleDelta.replace(FMultiSelectFieldStyle replacement) =
      _FMultiSelectFieldStyleReplace;

  /// Creates a partial modification of a [FMultiSelectFieldStyle].
  const factory FMultiSelectFieldStyleDelta.merge({
    FWidgetStateMap<Decoration>? decoration,
    EdgeInsetsGeometry? contentPadding,
    double? spacing,
    double? runSpacing,
  ...
  }) = _FMultiSelectFieldStyleMerge;
}

class _FMultiSelectFieldStyleReplace implements FMultiSelectFieldStyleDelta {
  const _FMultiSelectFieldStyleReplace(this._replacement);

  final FMultiSelectFieldStyle _replacement;

  @override
  FMultiSelectFieldStyle call(FMultiSelectFieldStyle _) => _replacement;
}

class _FMultiSelectFieldStyleMerge implements FMultiSelectFieldStyleDelta {
  const _FMultiSelectFieldStyleMerge({
    this.decoration,
    this.contentPadding,
    this.spacing,
    this.runSpacing,
  ...
  FMultiSelectFieldStyle call(FMultiSelectFieldStyle original) => FMultiSelectFieldStyle(
    ...
    hintPadding: hintPadding ?? original.hintPadding,
