...
extension $FSelectContentStyleTransformations on FSelectContentStyle {
  ...
  /// * [FSelectContentStyle.barrierFilter] - An optional callback that takes a [BuildContext] and the current animation transition value (0.0 to 1.0), and returns an [ImageFilter] that is used as the barrier.
  ...
  /// * [FSelectContentStyle.arrowStyle] - The arrow's style.
...
abstract class FSelectContentStyleDelta with Delta {
  ...
  const factory context() = _FSelectContentStyleContext;
