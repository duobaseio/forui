...
sealed class FSelectContentStyleDelta with Delta<FSelectContentStyle> {
  /// Creates a complete replacement for a [FSelectContentStyle].
  const factory FSelectContentStyleDelta.replace(FSelectContentStyle replacement) = _FSelectContentStyleReplace;

  /// Creates a partial modification of a [FSelectContentStyle].
  const factory FSelectContentStyleDelta.merge({
    ...
    EdgeInsetsGeometry? viewInsets,
  }) = _FSelectContentStyleMerge;
}

class _FSelectContentStyleReplace implements FSelectContentStyleDelta {
  const _FSelectContentStyleReplace(this._replacement);

  final FSelectContentStyle _replacement;

  @override
  FSelectContentStyle call(FSelectContentStyle _) => _replacement;
}

class _FSelectContentStyleMerge implements FSelectContentStyleDelta {
  const _FSelectContentStyleMerge({
    this.sectionStyle,
