...
sealed class FSelectStyleDelta with Delta<FSelectStyle> {
  /// Creates a complete replacement for a [FSelectStyle].
  const factory FSelectStyleDelta.replace(FSelectStyle replacement) = _FSelectStyleReplace;

  /// Creates a partial modification of a [FSelectStyle].
  const factory FSelectStyleDelta.merge({
...
class _FSelectStyleReplace implements FSelectStyleDelta {
  const _FSelectStyleReplace(this._replacement);

  final FSelectStyle _replacement;

  @override
  FSelectStyle call(FSelectStyle _) => _replacement;
}

class _FSelectStyleMerge implements FSelectStyleDelta {
  const _FSelectStyleMerge({this.fieldStyle, this.searchStyle, this.contentStyle, this.emptyTextStyle});
