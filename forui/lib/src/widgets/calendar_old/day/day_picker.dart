...
import 'package:forui/src/widgets/calendar_old/shared/entry.dart';

@SentinelValues(FCalendarOldDayPickerStyle, {'startDayOfWeek': '-1'})
...
class DayPicker extends StatefulWidget {
  ...
  final FCalendarOldDayPickerStyle style;
  final FLocalizations localization;
  final ValueWidgetBuilder<FCalendarOldDayData> dayBuilder;
...
class FCalendarOldDayPickerStyle with Diagnosticable, _$FCalendarOldDayPickerStyleFunctions {
  ...
  @override
  final FCalendarOldEntryStyle current;

  /// The styles of dates in the enclosing months.
  @override
  final FCalendarOldEntryStyle enclosing;
  ...
  /// Creates a [FCalendarOldDayPickerStyle].
  const FCalendarOldDayPickerStyle({
  ...
  /// Creates a [FCalendarOldDayPickerStyle] that inherits its properties.
  factory FCalendarOldDayPickerStyle.inherit({
