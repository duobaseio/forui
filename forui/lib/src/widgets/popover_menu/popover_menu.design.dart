...
sealed class FPopoverMenuStyleDelta with Delta<FPopoverMenuStyle> {
  /// Creates a complete replacement for a [FPopoverMenuStyle].
  const factory FPopoverMenuStyleDelta.replace(FPopoverMenuStyle replacement) = _FPopoverMenuStyleReplace;

  /// Creates a partial modification of a [FPopoverMenuStyle].
  const factory FPopoverMenuStyleDelta.merge({
    ...
    EdgeInsetsGeometry? viewInsets,
  }) = _FPopoverMenuStyleMerge;
}

class _FPopoverMenuStyleReplace implements FPopoverMenuStyleDelta {
  const _FPopoverMenuStyleReplace(this._replacement);

  final FPopoverMenuStyle _replacement;

  @override
  FPopoverMenuStyle call(FPopoverMenuStyle _) => _replacement;
}

class _FPopoverMenuStyleMerge implements FPopoverMenuStyleDelta {
  const _FPopoverMenuStyleMerge({
    this.itemGroupStyle,
    this.tileGroupStyle,
    this.maxWidth,
    this.decoration,
