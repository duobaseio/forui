...
sealed class FAccordionStyleDelta with Delta<FAccordionStyle> {
  /// Creates a complete replacement for a [FAccordionStyle].
  const factory FAccordionStyleDelta.replace(FAccordionStyle replacement) = _FAccordionStyleReplace;

  /// Creates a partial modification of a [FAccordionStyle].
  const factory FAccordionStyleDelta.merge({
    FWidgetStateMap<TextStyle>? titleTextStyle,
  ...
  }) = _FAccordionStyleMerge;
}

class _FAccordionStyleReplace implements FAccordionStyleDelta {
  const _FAccordionStyleReplace(this._replacement);

  final FAccordionStyle _replacement;

  @override
  FAccordionStyle call(FAccordionStyle _) => _replacement;
}

class _FAccordionStyleMerge implements FAccordionStyleDelta {
  const _FAccordionStyleMerge({
    this.titleTextStyle,
    this.childTextStyle,
    this.titlePadding,
    this.childPadding,
  ...
  FAccordionStyle call(FAccordionStyle original) => FAccordionStyle(
    ...
    titlePadding: titlePadding ?? original.titlePadding,
...
sealed class FAccordionMotionDelta with Delta<FAccordionMotion> {
  /// Creates a complete replacement for a [FAccordionMotion].
  const factory FAccordionMotionDelta.replace(FAccordionMotion replacement) = _FAccordionMotionReplace;

  /// Creates a partial modification of a [FAccordionMotion].
  const factory FAccordionMotionDelta.merge({
    Duration? expandDuration,
    Duration? collapseDuration,
    Curve? expandCurve,
    Curve? collapseCurve,
    ...
    Animatable<double>? revealTween,
    Animatable<double>? iconTween,
  }) = _FAccordionMotionMerge;
}

class _FAccordionMotionReplace implements FAccordionMotionDelta {
  const _FAccordionMotionReplace(this._replacement);

  final FAccordionMotion _replacement;

  @override
  FAccordionMotion call(FAccordionMotion _) => _replacement;
}

class _FAccordionMotionMerge implements FAccordionMotionDelta {
  const _FAccordionMotionMerge({
    this.expandDuration,
