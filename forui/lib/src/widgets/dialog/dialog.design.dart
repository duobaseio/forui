...
sealed class FDialogRouteStyleDelta with Delta<FDialogRouteStyle> {
  /// Creates a complete replacement for a [FDialogRouteStyle].
  const factory FDialogRouteStyleDelta.replace(FDialogRouteStyle replacement) = _FDialogRouteStyleReplace;

  /// Creates a partial modification of a [FDialogRouteStyle].
  const factory FDialogRouteStyleDelta.merge({
    ImageFilter Function(double)? Function()? barrierFilter,
    FDialogRouteMotionDelta? motion,
  }) = _FDialogRouteStyleMerge;
}

class _FDialogRouteStyleReplace implements FDialogRouteStyleDelta {
  const _FDialogRouteStyleReplace(this._replacement);

  final FDialogRouteStyle _replacement;

  @override
  FDialogRouteStyle call(FDialogRouteStyle _) => _replacement;
}

class _FDialogRouteStyleMerge implements FDialogRouteStyleDelta {
  const _FDialogRouteStyleMerge({this.barrierFilter, this.motion});
...
sealed class FDialogRouteMotionDelta with Delta<FDialogRouteMotion> {
  /// Creates a complete replacement for a [FDialogRouteMotion].
  const factory FDialogRouteMotionDelta.replace(FDialogRouteMotion replacement) = _FDialogRouteMotionReplace;

  /// Creates a partial modification of a [FDialogRouteMotion].
  const factory FDialogRouteMotionDelta.merge({
    Duration? entranceDuration,
    Duration? exitDuration,
    Curve? barrierCurve,
  }) = _FDialogRouteMotionMerge;
}

class _FDialogRouteMotionReplace implements FDialogRouteMotionDelta {
  const _FDialogRouteMotionReplace(this._replacement);

  final FDialogRouteMotion _replacement;

  @override
  FDialogRouteMotion call(FDialogRouteMotion _) => _replacement;
}

class _FDialogRouteMotionMerge implements FDialogRouteMotionDelta {
  const _FDialogRouteMotionMerge({this.entranceDuration, this.exitDuration, this.barrierCurve});
...
sealed class FDialogStyleDelta with Delta<FDialogStyle> {
  /// Creates a complete replacement for a [FDialogStyle].
  const factory FDialogStyleDelta.replace(FDialogStyle replacement) = _FDialogStyleReplace;

  /// Creates a partial modification of a [FDialogStyle].
  const factory FDialogStyleDelta.merge({
    ImageFilter Function(double)? Function()? backgroundFilter,
    BoxDecorationDelta? decoration,
    EdgeInsetsGeometry? insetPadding,
    FDialogContentStyleDelta? horizontalStyle,
    FDialogContentStyleDelta? verticalStyle,
    FDialogMotionDelta? motion,
  }) = _FDialogStyleMerge;
}

class _FDialogStyleReplace implements FDialogStyleDelta {
  const _FDialogStyleReplace(this._replacement);

  final FDialogStyle _replacement;

  @override
  FDialogStyle call(FDialogStyle _) => _replacement;
}

class _FDialogStyleMerge implements FDialogStyleDelta {
  const _FDialogStyleMerge({
  ...
  final FDialogContentStyleDelta? horizontalStyle;

  final FDialogContentStyleDelta? verticalStyle;
  ...
  FDialogStyle call(FDialogStyle original) => FDialogStyle(
    ...
    insetPadding: insetPadding ?? original.insetPadding,
...
sealed class FDialogMotionDelta with Delta<FDialogMotion> {
  /// Creates a complete replacement for a [FDialogMotion].
  const factory FDialogMotionDelta.replace(FDialogMotion replacement) = _FDialogMotionReplace;

  /// Creates a partial modification of a [FDialogMotion].
  const factory FDialogMotionDelta.merge({
    Curve? expandCurve,
    Curve? collapseCurve,
    Curve? fadeInCurve,
    Curve? fadeOutCurve,
...
class _FDialogMotionReplace implements FDialogMotionDelta {
  const _FDialogMotionReplace(this._replacement);

  final FDialogMotion _replacement;

  @override
  FDialogMotion call(FDialogMotion _) => _replacement;
}

class _FDialogMotionMerge implements FDialogMotionDelta {
  const _FDialogMotionMerge({
    this.expandCurve,
    this.collapseCurve,
    this.fadeInCurve,
    this.fadeOutCurve,
