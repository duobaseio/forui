...
extension $FDialogStyleTransformations on FDialogStyle {
  ...
  /// * [FDialogStyle.slidePressHapticFeedback] - The haptic feedback for when the user slides from one action to another when [slideableActions] is enabled.
  ...
  FDialogStyle copyWith({
    ...
    contentStyle: FDialogContentStyles(contentStyle?.call(this.contentStyle) ?? this.contentStyle),
  ...
  FDialogStyle lerp(FDialogStyle other, double t) => .new(
    ...
    contentStyle: FDialogContentStyles(.lerpWhere(contentStyle, other.contentStyle, t, (a, b, t) => a!.lerp(b!, t))),
...
mixin _$FDialogStyleFunctions on Diagnosticable implements FDialogStyleDelta {
  ...
  FDialogContentStyles get contentStyle;
...
class _FDialogStyleDelta implements FDialogStyleDelta {
  ...
  FDialogStyle call(FDialogStyle original) => FDialogStyle(
    ...
    contentStyle: FDialogContentStyles(contentStyle?.call(original.contentStyle) ?? original.contentStyle),
