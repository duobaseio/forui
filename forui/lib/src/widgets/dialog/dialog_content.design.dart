...
sealed class FDialogContentStyleDelta with Delta<FDialogContentStyle> {
  /// Creates a complete replacement for a [FDialogContentStyle].
  const factory FDialogContentStyleDelta.replace(FDialogContentStyle replacement) = _FDialogContentStyleReplace;

  /// Creates a partial modification of a [FDialogContentStyle].
  const factory FDialogContentStyleDelta.merge({
    TextStyleDelta? titleTextStyle,
    TextStyleDelta? bodyTextStyle,
    EdgeInsetsGeometry? padding,
    double? actionSpacing,
  }) = _FDialogContentStyleMerge;
}

class _FDialogContentStyleReplace implements FDialogContentStyleDelta {
  const _FDialogContentStyleReplace(this._replacement);

  final FDialogContentStyle _replacement;

  @override
  FDialogContentStyle call(FDialogContentStyle _) => _replacement;
}

class _FDialogContentStyleMerge implements FDialogContentStyleDelta {
  const _FDialogContentStyleMerge({this.titleTextStyle, this.bodyTextStyle, this.padding, this.actionSpacing});
