...
sealed class FCheckboxStyleDelta with Delta<FCheckboxStyle> {
  /// Creates a complete replacement for a [FCheckboxStyle].
  const factory FCheckboxStyleDelta.replace(FCheckboxStyle replacement) = _FCheckboxStyleReplace;

  /// Creates a partial modification of a [FCheckboxStyle].
  const factory FCheckboxStyleDelta.merge({
  ...
  }) = _FCheckboxStyleMerge;
}

class _FCheckboxStyleReplace implements FCheckboxStyleDelta {
  const _FCheckboxStyleReplace(this._replacement);

  final FCheckboxStyle _replacement;

  @override
  FCheckboxStyle call(FCheckboxStyle _) => _replacement;
}

class _FCheckboxStyleMerge implements FCheckboxStyleDelta {
  const _FCheckboxStyleMerge({
    this.tappableStyle,
    this.focusedOutlineStyle,
    this.size,
    this.iconStyle,
...
sealed class FCheckboxMotionDelta with Delta<FCheckboxMotion> {
  /// Creates a complete replacement for a [FCheckboxMotion].
  const factory FCheckboxMotionDelta.replace(FCheckboxMotion replacement) = _FCheckboxMotionReplace;

  /// Creates a partial modification of a [FCheckboxMotion].
  const factory FCheckboxMotionDelta.merge({
    Duration? fadeInDuration,
    Duration? fadeOutDuration,
    Curve? fadeInCurve,
    Curve? fadeOutCurve,
  }) = _FCheckboxMotionMerge;
}

class _FCheckboxMotionReplace implements FCheckboxMotionDelta {
  const _FCheckboxMotionReplace(this._replacement);

  final FCheckboxMotion _replacement;

  @override
  FCheckboxMotion call(FCheckboxMotion _) => _replacement;
}

class _FCheckboxMotionMerge implements FCheckboxMotionDelta {
  const _FCheckboxMotionMerge({this.fadeInDuration, this.fadeOutDuration, this.fadeInCurve, this.fadeOutCurve});
