...
sealed class FTimePickerStyleDelta with Delta<FTimePickerStyle> {
  /// Creates a complete replacement for a [FTimePickerStyle].
  const factory FTimePickerStyleDelta.replace(FTimePickerStyle replacement) = _FTimePickerStyleReplace;

  /// Creates a partial modification of a [FTimePickerStyle].
  const factory FTimePickerStyleDelta.merge({
    EdgeInsetsDirectional? padding,
    double? diameterRatio,
    double? squeeze,
    double? magnification,
  ...
  }) = _FTimePickerStyleMerge;
}

class _FTimePickerStyleReplace implements FTimePickerStyleDelta {
  const _FTimePickerStyleReplace(this._replacement);

  final FTimePickerStyle _replacement;

  @override
  FTimePickerStyle call(FTimePickerStyle _) => _replacement;
}

class _FTimePickerStyleMerge implements FTimePickerStyleDelta {
  const _FTimePickerStyleMerge({
    this.padding,
    this.diameterRatio,
    this.squeeze,
    this.magnification,
