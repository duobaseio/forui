...
extension $FTooltipStyleTransformations on FTooltipStyle {
  ...
  /// * [FTooltipStyle.constraints] - The tooltip's constraints.
  /// * [FTooltipStyle.arrowStyle] - The arrow's style.
...
abstract class FTooltipStyleDelta with Delta {
  ...
  const factory context() = _FTooltipStyleContext;
...
abstract class FTooltipMotionDelta with Delta {
  ...
  const factory context() = _FTooltipMotionContext;
