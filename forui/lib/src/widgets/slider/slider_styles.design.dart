...
extension type const FSliderAxisVariantConstraint._(FVariantConstraint _) implements FVariantConstraint {
  ...
  factory not(FSliderAxisVariant variant) => FSliderAxisVariantConstraint._(Not(variant));
...
extension type const FSliderVariantConstraint._(FVariantConstraint _) implements FVariantConstraint {
  ...
  factory not(FSliderVariant variant) => FSliderVariantConstraint._(Not(variant));
...
extension $FSliderStyleTransformations on FSliderStyle {
  ...
  /// * [FSliderStyle.collisionHapticFeedback] - The haptic feedback when the active edge collides with the track's limit, the other thumb, or a configured min range extent.
  /// * [FSliderStyle.tickHapticFeedback] - The haptic feedback when the active edge lands on a new discrete tick.
  ...
  FSliderStyle copyWith({
    ...
    collisionHapticFeedback: collisionHapticFeedback ?? this.collisionHapticFeedback,
    tickHapticFeedback: tickHapticFeedback ?? this.tickHapticFeedback,
  ...
  FSliderStyle lerp(FSliderStyle other, double t) => .new(
    ...
    collisionHapticFeedback: t < 0.5 ? collisionHapticFeedback : other.collisionHapticFeedback,
    tickHapticFeedback: t < 0.5 ? tickHapticFeedback : other.tickHapticFeedback,
...
mixin _$FSliderStyleFunctions on Diagnosticable implements FSliderStyleDelta {
  ...
  Future<void> Function() get collisionHapticFeedback;
  Future<void> Function() get tickHapticFeedback;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('collisionHapticFeedback', collisionHapticFeedback, level: .debug))
      ..add(DiagnosticsProperty('tickHapticFeedback', tickHapticFeedback, level: .debug))
  ...
  bool operator ==(Object other) =>
      ...
      (other is FSliderStyle &&
          ...
          collisionHapticFeedback == other.collisionHapticFeedback &&
          tickHapticFeedback == other.tickHapticFeedback &&
  ...
  int get hashCode =>
      ...
      collisionHapticFeedback.hashCode ^
      tickHapticFeedback.hashCode ^
...
abstract class FSliderStyleDelta with Delta {
  ...
  const factory context() = _FSliderStyleContext;
...
class _FSliderStyleDelta implements FSliderStyleDelta {
  const new({
    ...
    this.markStyle,
    this.tooltipStyle,
    this.collisionHapticFeedback,
    this.tickHapticFeedback,
    this.borderRadius,
  ...
  FSliderStyle call(FSliderStyle original) => FSliderStyle(
    ...
    collisionHapticFeedback: collisionHapticFeedback ?? original.collisionHapticFeedback,
    tickHapticFeedback: tickHapticFeedback ?? original.tickHapticFeedback,
