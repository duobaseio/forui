...
sealed class FSliderThumbStyleDelta with Delta<FSliderThumbStyle> {
  /// Creates a complete replacement for a [FSliderThumbStyle].
  const factory FSliderThumbStyleDelta.replace(FSliderThumbStyle replacement) = _FSliderThumbStyleReplace;

  /// Creates a partial modification of a [FSliderThumbStyle].
  const factory FSliderThumbStyleDelta.merge({
    FWidgetStateMap<Color>? color,
    FWidgetStateMap<Color>? borderColor,
    double? borderWidth,
    FFocusedOutlineStyleDelta? focusedOutlineStyle,
  }) = _FSliderThumbStyleMerge;
}

class _FSliderThumbStyleReplace implements FSliderThumbStyleDelta {
  const _FSliderThumbStyleReplace(this._replacement);

  final FSliderThumbStyle _replacement;

  @override
  FSliderThumbStyle call(FSliderThumbStyle _) => _replacement;
}

class _FSliderThumbStyleMerge implements FSliderThumbStyleDelta {
  const _FSliderThumbStyleMerge({this.color, this.borderColor, this.borderWidth, this.focusedOutlineStyle});
