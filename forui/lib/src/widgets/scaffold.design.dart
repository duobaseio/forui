...
sealed class FScaffoldStyleDelta with Delta<FScaffoldStyle> {
  /// Creates a complete replacement for a [FScaffoldStyle].
  const factory FScaffoldStyleDelta.replace(FScaffoldStyle replacement) = _FScaffoldStyleReplace;

  /// Creates a partial modification of a [FScaffoldStyle].
  const factory FScaffoldStyleDelta.merge({
    SystemUiOverlayStyle? systemOverlayStyle,
    Color? backgroundColor,
    Color? sidebarBackgroundColor,
    EdgeInsetsGeometry? childPadding,
  ...
  }) = _FScaffoldStyleMerge;
}

class _FScaffoldStyleReplace implements FScaffoldStyleDelta {
  const _FScaffoldStyleReplace(this._replacement);

  final FScaffoldStyle _replacement;

  @override
  FScaffoldStyle call(FScaffoldStyle _) => _replacement;
}

class _FScaffoldStyleMerge implements FScaffoldStyleDelta {
  const _FScaffoldStyleMerge({
