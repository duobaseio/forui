...
sealed class FLineCalendarStyleDelta with Delta<FLineCalendarStyle> {
  /// Creates a complete replacement for a [FLineCalendarStyle].
  const factory FLineCalendarStyleDelta.replace(FLineCalendarStyle replacement) = _FLineCalendarStyleReplace;

  /// Creates a partial modification of a [FLineCalendarStyle].
  const factory FLineCalendarStyleDelta.merge({
    EdgeInsetsGeometry? padding,
    double? contentEdgeSpacing,
    double? contentSpacing,
    FWidgetStateMap<BoxDecoration>? decoration,
  ...
  }) = _FLineCalendarStyleMerge;
}

class _FLineCalendarStyleReplace implements FLineCalendarStyleDelta {
  const _FLineCalendarStyleReplace(this._replacement);

  final FLineCalendarStyle _replacement;

  @override
  FLineCalendarStyle call(FLineCalendarStyle _) => _replacement;
}

class _FLineCalendarStyleMerge implements FLineCalendarStyleDelta {
  const _FLineCalendarStyleMerge({
    this.padding,
  ...
  FLineCalendarStyle call(FLineCalendarStyle original) => FLineCalendarStyle(
    ...
    todayIndicatorColor: todayIndicatorColor ?? original.todayIndicatorColor,
    dateTextStyle: dateTextStyle ?? original.dateTextStyle,
    weekdayTextStyle: weekdayTextStyle ?? original.weekdayTextStyle,
