...
extension type const FButtonVariantConstraint._(FVariantConstraint _) implements FVariantConstraint {
  ...
  factory not(FButtonVariant variant) => FButtonVariantConstraint._(Not(variant));
...
extension type const FButtonSizeVariantConstraint._(FVariantConstraint _) implements FVariantConstraint {
  ...
  factory not(FButtonSizeVariant variant) => FButtonSizeVariantConstraint._(Not(variant));
...
abstract class FButtonStyleDelta with Delta {
  ...
  const factory context() = _FButtonStyleContext;
...
class _FButtonStyleDelta implements FButtonStyleDelta {
  const new({this.decoration, this.contentStyle, this.iconContentStyle, this.tappableStyle, this.focusedOutlineStyle});
