...
String generateSnippets((Map<String, (String, String)>, Map<String, (String, String)>) mapped) {
  final sources = [
    for (final MapEntry(:key, value: (name, source)) in mapped.$1.entries) "'$key': ('$name', r'''$source''')",
  ];
  final init = [
  ...
  final library = LibraryBuilder()
    ...
    ..body.addAll([
      (FieldBuilder()
          ...
          .build(),
      (FieldBuilder()
            ..docs.addAll(['/// The main.dart snippets used by `dart forui init`. Generated by tool/cli_generator.'])
            ..name = 'init'
            ..modifier = .constant
            ..assignment = Code('{\n  ${init.join(',\n  ')}\n}'))
          .build(),
...
Future<(Map<String, (String, String)>, Map<String, (String, String)>)> mapSnippets(
