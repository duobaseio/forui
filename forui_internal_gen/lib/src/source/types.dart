...
/// As a workaround, we parse K from the last line of the field's docs in the format: `/// * [<constraint>]`.
///
/// This will be removed once augmentation classes are available.
String fieldType(FieldElement field) {
  if (field.type case InterfaceType(:final element, :final typeArguments) when element.name == 'FVariants') {
    ...
    return 'FVariants<$k, ${v.getDisplayString()}, ${d.getDisplayString()}>';
  }
