...
enum PrimaryColor implements Option {
  amber(
    code: 'b',
    name: 'Amber',
    light: PrimaryColors(primary: 0xFFBB4D00, primaryForeground: 0xFFFFFBEB),
    dark: PrimaryColors(primary: 0xFF973C00, primaryForeground: 0xFFFFFBEB),
  ),
  blue(
    code: 'c',
    name: 'Blue',
    light: PrimaryColors(primary: 0xFF1447E6, primaryForeground: 0xFFEFF6FF),
    dark: PrimaryColors(primary: 0xFF193CB8, primaryForeground: 0xFFEFF6FF),
  ),
  cyan(
    code: 'd',
    name: 'Cyan',
    light: PrimaryColors(primary: 0xFF007595, primaryForeground: 0xFFECFEFF),
    dark: PrimaryColors(primary: 0xFF005F78, primaryForeground: 0xFFECFEFF),
  ),
  emerald(
    code: 'e',
    name: 'Emerald',
    light: PrimaryColors(primary: 0xFF007A55, primaryForeground: 0xFFECFDF5),
    dark: PrimaryColors(primary: 0xFF006045, primaryForeground: 0xFFECFDF5),
  ),
  fuchsia(
    code: 'f',
    name: 'Fuchsia',
    light: PrimaryColors(primary: 0xFFA800B7, primaryForeground: 0xFFFDF4FF),
    dark: PrimaryColors(primary: 0xFF8A0194, primaryForeground: 0xFFFDF4FF),
  ),
  green(
    code: 'g',
    name: 'Green',
    light: PrimaryColors(primary: 0xFF008236, primaryForeground: 0xFFF0FDF4),
    dark: PrimaryColors(primary: 0xFF016630, primaryForeground: 0xFFF0FDF4),
  ),
  indigo(
    code: 'h',
    name: 'Indigo',
    light: PrimaryColors(primary: 0xFF432DD7, primaryForeground: 0xFFEEF2FF),
    dark: PrimaryColors(primary: 0xFF372AAC, primaryForeground: 0xFFEEF2FF),
  ),
  lime(
    code: 'i',
    name: 'Lime',
    light: PrimaryColors(primary: 0xFF9AE600, primaryForeground: 0xFF35530E),
    dark: PrimaryColors(primary: 0xFF7CCF00, primaryForeground: 0xFF35530E),
  ),
  orange(
    code: 'j',
    name: 'Orange',
    light: PrimaryColors(primary: 0xFFCA3500, primaryForeground: 0xFFFFF7ED),
    dark: PrimaryColors(primary: 0xFF9F2D00, primaryForeground: 0xFFFFF7ED),
  ),
  pink(
    code: 'k',
    name: 'Pink',
    light: PrimaryColors(primary: 0xFFC6005C, primaryForeground: 0xFFFDF2F8),
    dark: PrimaryColors(primary: 0xFFA3004C, primaryForeground: 0xFFFDF2F8),
  ),
  purple(
    code: 'l',
    name: 'Purple',
    light: PrimaryColors(primary: 0xFF8200DB, primaryForeground: 0xFFFAF5FF),
    dark: PrimaryColors(primary: 0xFF6E11B0, primaryForeground: 0xFFFAF5FF),
  ),
  red(
    code: 'm',
    name: 'Red',
    light: PrimaryColors(primary: 0xFFC10007, primaryForeground: 0xFFFEF2F2),
    dark: PrimaryColors(primary: 0xFF9F0712, primaryForeground: 0xFFFEF2F2),
  ),
  rose(
    code: 'n',
    name: 'Rose',
    light: PrimaryColors(primary: 0xFFC70036, primaryForeground: 0xFFFFF1F2),
    dark: PrimaryColors(primary: 0xFFA50036, primaryForeground: 0xFFFFF1F2),
  ),
  sky(
    code: 'o',
    name: 'Sky',
    light: PrimaryColors(primary: 0xFF0069A8, primaryForeground: 0xFFF0F9FF),
    dark: PrimaryColors(primary: 0xFF00598A, primaryForeground: 0xFFF0F9FF),
  ),
  teal(
    code: 'p',
    name: 'Teal',
    light: PrimaryColors(primary: 0xFF00786F, primaryForeground: 0xFFF0FDFA),
    dark: PrimaryColors(primary: 0xFF005F5A, primaryForeground: 0xFFF0FDFA),
  ),
  violet(
    code: 'q',
    name: 'Violet',
    light: PrimaryColors(primary: 0xFF7008E7, primaryForeground: 0xFFF5F3FF),
    dark: PrimaryColors(primary: 0xFF5D0EC0, primaryForeground: 0xFFF5F3FF),
  ),
  yellow(
    code: 'r',
    name: 'Yellow',
