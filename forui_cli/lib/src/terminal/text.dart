...
///
/// Counts most CJK ideographs, Hangul, fullwidth forms, and emoji as 2 columns, combining and zero-width marks as 0,
/// and everything else as 1. This is a small approximation good enough for box drawing and in-place re-rendering; some
/// ambiguous-width and emoji-sequence cases are not handled (documented limitation).
...
bool _isZeroWidth(int r) =>
    ...
    (r >= 0x200C && r <= 0x200F); // zero-width joiners / marks
